...
<div class="min-h-svh bg-background font-sans text-foreground antialiased" style="--header-height: calc(var(--spacing) * 14);">
  <header class="sticky top-0 z-50 w-full bg-background" style="height: var(--header-height);">
    <div class="mx-auto flex h-full w-full max-w-[1400px] items-center px-4 3xl:max-w-screen-2xl lg:px-8">
      <!-- Mobile nav -->
      <button
      ...
      <div class="ml-auto flex items-center gap-2 md:flex-1 md:justify-end">
        ...
        <a
          href="/create"
          class="inline-flex h-8 items-center justify-center gap-1.5 rounded-lg bg-primary px-3 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
        >
